...
%>
<h1>欢迎投票</h1>
欢迎您，<font color="red">${sessionScope.username}</font>！请选择一张图片投票&nbsp;&nbsp;&nbsp;<a href="loginForm.action">[注销]</a>
<form name="voteForm" action="vote" method="post">
    <div id="box" onclick="choicetest('image',3)">
        <table align="center">
            ...
            %>
            <tr>
                <td colspan="5" width="150" height="50" align="right" valign="middle"><input type="button" value="投票" class="buttonFont-style"
                                                                                             onclick="vote();"/>
                </td>
            </tr>
        </table>
