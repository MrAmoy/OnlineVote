...
<form name="registForm" action="regist" method="post">
    <table border="0" bordercolor="red" align="center">
        <tr>
            ...
            <td align="left">
                <input type="text" style="width: 200px;height: 25px" name="username" id="username" onblur="nameBlur();" onfocus="nameFocus()"/>
            </td>
            <td width="100">
                <span id="usernameMsg">
                    <font color="red"></font>
        ...
        <tr>
            ...
            <td align="left"><input type="password" style="width: 200px;height: 25px" name="password1" id="password1"/></td>
            <td width="100">
        ...
        <tr>
            ...
            <td align="left"><input type="password" style="width: 200px;height: 25px" name="password2" id="password2" onblur="password2Blur();"/></td>
            <td width="100">
        ...
        <tr>
            <td colspan="3" align="center" valign="middle"><input type="button" value="注册" style="color: crimson" onclick="regist();" class="buttonFont-style"/>
                &nbsp;&nbsp;&nbsp;
